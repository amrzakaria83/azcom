...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('list_contacs', function (Blueprint $table) {
            ...
            $table->text('parentlist_id')->nullable();
            $table->unsignedInteger('taregetvisit')->nullable();
            $table->unsignedBigInteger('sales_funel_id')->nullable();
            $table->foreign('sales_funel_id')
                    ->references('id')->on('sales_funels')->onDelete('cascade')->comment('sales_funel_id');
