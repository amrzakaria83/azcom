            ...
            <div class="d-flex flex-column flex-xl-row p-7">
                ...
                <div class="flex-lg-row-fluid me-xl-15 mb-20 mb-xl-0">
                    ...
                    <div class="mb-0">
                        ...
                        <h1 class="text-dark mb-10">{{$data->exam->name}}</h1>
                            ...
                            @foreach ($data->exam->questions as $question)
                                ...
                                <div class="d-flex mb-10">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        @if ($question->examAnswers)
                                        <span class="text-muted mb-3 fw-semibold fs-6">
                                            @if ($question->examAnswers->is_correct == 'correct')
                                            ...
                                            {{$question->examAnswers->answer->name}}
                                        </span>
                                        @else 
                                        <span class="text-muted mb-3 fw-semibold fs-6">
                                            <span class="svg-icon svg-icon-1x me-2 ms-n1 mt-2 svg-icon-danger">
                                        ...
                                        @foreach ($question->question->answers as $item)
                                            @if (isset($question->examAnswers->answer->id) && $item->id != $question->examAnswers->answer->id)
                ...
                <div class="flex-column flex-lg-row-auto w-100 mw-lg-300px mw-xxl-350px">
                    <div class="card-rounded bg-primary bg-opacity-5 p-10 mb-15">
                        ...
                        <div class="d-flex align-items-center mb-10">
                            <!--begin::Icon-->
                            <i class="bi bi-award text-primary fs-1 me-5"></i>
                            <!--end::SymIconbol-->
                            <!--begin::Info-->
                            <div class="d-flex flex-column">
                                <h5 class="text-gray-800 fw-bold">{{$data->result}} / {{$data->total}}</h5>
                                <!--begin::Section-->
                                <div class="fw-semibold">
                                    <!--begin::Desc-->
                                    <span class="text-muted">{{trans('exam.result')}}</span>
                                    <!--end::Desc-->
                                </div>
                                <!--end::Section-->
                            </div>
                        ...
                        <div class="d-flex align-items-center mb-10">
                            ...
                            <!--begin::Info-->
                            <div class="d-flex flex-column">
                                <h5 class="text-gray-800 fw-bold">{{$data->exam->duration}}</h5>
                                <!--begin::Section-->
                                <div class="fw-semibold">
                                    <!--begin::Desc-->
                        ...
                        <div class="d-flex align-items-center mb-10">
                            ...
                            <!--begin::Info-->
                            <div class="d-flex flex-column">
                                <h5 class="text-gray-800 fw-bold">{{$data->exam->classroom->name}}</h5>
                                <!--begin::Section-->
                                <div class="fw-semibold">
                                    <!--begin::Desc-->
                        ...
                        <div class="d-flex align-items-center mb-10">
                            ...
                            <!--begin::Info-->
                            <div class="d-flex flex-column">
                                <h5 class="text-gray-800 fw-bold">{{$data->exam->subject->name}}</h5>
                                <!--begin::Section-->
                                <div class="fw-semibold">
                                    <!--begin::Desc-->
