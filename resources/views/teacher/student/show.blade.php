                            ...
                            <div class="card" id="kt_chat_messenger" style="border: 1px solid #f4f4f4;">
                                ...
                                <!--begin::Card footer-->
                                    ...
                                    <div class="card-footer pt-4" id="kt_chat_messenger_footer">
                                        <!--begin::Input-->
                                        <input type="hidden" id="teacher_id" name="teacher_id" value="{{$teachers[0]->id}}" />
...
calendar.render();
    ...
    $('.teacher').click(function (e) {
        ...
        $.ajax({
            type: "GET",
            url: "{{url('/')}}"+"/teacher/messages/getmsg/"+"{{$data->id}}"+'/'+ $(this).attr("teacher-data"),
            success: function (data) {
                $("#chat").html(data);
    ...
    function fetchbdg(){
        ...
        if (teacher_id) {
            $.ajax({
                type: "GET",
                url: "{{url('/')}}"+"/teacher/messages/getmsg/"+"{{$data->id}}"+'/'+ teacher_id,
                success: function (data) {
                    $("#chat").html(data);
                    $('#chat').scrollTop($('#chat')[0].scrollHeight);
                }
