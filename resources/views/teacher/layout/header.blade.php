    ...
    <div class="d-flex flex-stack flex-grow-1">
        ...
        <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
            ...
            <div class="app-navbar-item ms-2 ms-lg-6">
                <!--begin::Menu- wrapper-->
                <?php 
                    $messages_noti = \App\Models\Message::where('receiver_type', 'teacher')->where('receiver_id', Auth::guard('teacher')->id())->where('status', 'unread')->get();
                ?>
                <div class="btn btn-icon btn-custom btn-color-gray-600 btn-active-color-primary w-35px h-35px w-md-40px h-md-40px position-relative" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                    ...
                    <span class="position-absolute top-0 start-100 translate-middle badge badge-circle badge-danger w-15px h-15px ms-n4 mt-3">{{$messages_noti->count()}}</span>
                </div>
                <!--begin::Menu-->
                <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                    <!--begin::Heading-->
                    <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{asset('dash/assets/media/misc/menu-header-bg.jpg')}}')">
                        <!--begin::Title-->
                        <h3 class="text-white fw-semibold px-9 mt-10 mb-6">الاشعارات</h3>
                        <!--end::Title-->
                        <!--begin::Tabs-->
                        <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
                            <li class="nav-item">
                                <a class="nav-link text-white opacity-75 opacity-state-100 pb-4 active" data-bs-toggle="tab" href="#kt_topbar_notifications_2">الرسائل</a>
                            </li>
                        </ul>
                        <!--end::Tabs-->
                    </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
                            ...
                            <div class="scroll-y mh-325px my-5 px-8">
                                @foreach ($messages_noti as $message_item)
                                    <!--begin::Item-->
                                    <div class="d-flex flex-stack py-4">
                                        <!--begin::Section-->
                                        <div class="d-flex align-items-center me-2">
                                            @if ($message_item->sender_type == 'student')
                                                <a href="{{url('/teacher/messages/getmsgdetails')}}/{{$message_item->sender_id}}/{{$message_item->receiver_id}}" class="text-gray-800 text-hover-primary fw-semibold">رساله من </a>
                                            @else
                                                <a href="{{url('/teacher/messages/getmsgdetails')}}/{{$message_item->receiver_id}}/{{$message_item->sender_id}}" class="text-gray-800 text-hover-primary fw-semibold">رساله من </a>
                                            @endif
                                        </div>
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                        <span class="badge badge-light fs-8">
                                            {{$message_item->sender->name ?? ''}}
                                            <span class="w-70px badge badge-light-success mx-4">
                                                @if ($message_item->receiver_type == 'student')
                                                    طالب
                                                @else
                                                    مدرس
                                                @endif
            ...
            <div class="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
                ...
                <div class="cursor-pointer symbol symbol-circle symbol-30px symbol-lg-45px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-start">
                    @if (Auth::guard('teacher')->user()->getMedia('profile')->count())
                        <img src="{{Auth::guard('teacher')->user()->getFirstMediaUrl('profile')}}" alt="{{$settings->append_name}}" />
                    @else
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="symbol symbol-50px me-5">
                                @if (Auth::guard('teacher')->user()->getMedia('profile')->count())
                                <img alt="{{$settings->append_name}}" src="{{Auth::guard('teacher')->user()->getFirstMediaUrl('profile')}}" />
                                @else
                                    <img alt="{{$settings->append_name}}" src="{{asset('dash/assets/media/avatars/blank.png')}}" />
                                @endif
                            </div>
                            ...
                            <div class="d-flex flex-column">
                                <div class="fw-bold d-flex align-items-center fs-5">{{Auth::guard('teacher')->name}}</div>
                                <a href="javascript:;" class="fw-semibold text-muted text-hover-primary fs-7">{{Auth::guard('teacher')->user()->email}}</a>
                            </div>
                            <!--end::Username-->
                        </div>
                    </div>
                    ...
                    <div class="menu-item px-5">
                        <a href="{{route('teacher.employees.show', Auth::guard('teacher')->id())}}" class="menu-link px-5">{{trans('auth.profile')}}</a>
                    </div>
                    ...
                    <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
                        <a href="#" class="menu-link px-5">
                            <span class="menu-title position-relative">{{trans('lang.lang')}}
                    ...
                    <div class="menu-item px-5">
                        <a href="{{route('teacher.logout')}}" class="menu-link px-5">{{trans('auth.logout')}}</a>
                    </div>
                    <!--end::Menu item-->
                </div>
            ...
            <div class="app-navbar-item ms-2 ms-lg-6 me-lg-5">
                <!--begin::Link-->
                <a href="{{route('teacher.logout')}}" class="btn btn-icon btn-custom btn-color-gray-600 btn-active-color-primary w-35px h-35px w-md-40px h-md-40px">
