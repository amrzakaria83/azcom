    ...
    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_header_nav'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            <li class="breadcrumb-item text-muted px-2">
                <a  href="#" class="text-muted text-hover-primary">{{trans('lang.accounts')}}</a>
            </li>
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            <a href="{{route('teacher.users.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
                    ...
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-start">{{trans('account.name')}}</th>
                                <th class="min-w-125px text-start">{{trans('account.phone')}}</th>
                                <th class="min-w-125px text-start">{{trans('account.is_active')}}</th>
                                <th class="min-w-125px text-start">{{trans('account.action')}}</th>
                            </tr>
                            <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_filter_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">{{trans('account.filter')}}</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                                ...
                                <!--begin::Form-->
                                    ...
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <label class="required fw-semibold fs-6 mb-2">{{trans('account.is_active')}}</label>
                                            <select name="is_active" id="is_active" data-control="select2" data-placeholder="{{trans('account.choose')}}" data-hide-search="true" class="form-select form-select-solid fw-bold">
                                                <option></option>
                                                <option value="1">{{trans('account.active')}}</option>
                                                <option value="0">{{trans('account.notactive')}}</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="text-center pt-15">
                                        <button type="button" class="btn btn-light me-3" data-bs-dismiss="modal">{{trans('account.close')}}</button>
                                        <button type="submit" class="btn btn-primary" id="submit">
                                            <span class="indicator-label">{{trans('account.save')}}</span>
            ...
            if (checkIDs.length > 0) {
                ...
                Swal.fire({
                    ...
                    if (isConfirm.value) {
                        $.ajax(
                        {
                            url: "{{route('teacher.users.delete')}}",
                            type: 'post',
                            dataType: "JSON",
                            data: {
                                "id": checkIDs,
