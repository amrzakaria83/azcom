    ...
    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_header_nav'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            <li class="breadcrumb-item text-muted px-2">
                <a  href="#" class="text-muted text-hover-primary">{{trans('lang.events')}}</a>
            </li>
                ...
                <div class="card-header border-0 pt-6">
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-db-table-filter="search" id="search" name="search" class="form-control form-control-solid bg-light-dark text-dark w-250px ps-14" placeholder="{{trans('blog.search')}}" />
                        </div>
                    </div>
                    ...
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-start">{{trans('blog.title')}}</th>
                                <th class="min-w-125px text-start">{{trans('blog.type')}}</th>
                                <th class="min-w-125px text-start">{{trans('blog.action')}}</th>
                            </tr>
                            <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_filter_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">{{trans('blog.filter')}}</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                                ...
                                <!--begin::Form-->
                                    ...
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                        ...
                                        <div class="fv-row mb-7">
                                            <label class="required fw-semibold fs-6 mb-2">{{trans('blog.type')}}  </label>
                                            <select  data-control="select2" id="type" data-placeholder="{{trans('blog.choose')}}" class="newstype input-text form-control  form-select  mb-3 mb-lg-0"  name="type">
                                                <option></option>
                                                <option value="news">{{trans('blog.news')}}</option>
                                                <option value="gallery">{{trans('blog.gallery')}} </option>
                                                <option value="video">{{trans('blog.video')}} </option>
                                            </select>
                                        </div>

                                        <div class="mb-7">
                                            <label class="required fw-semibold fs-6 mb-2">{{trans('blog.created_at')}}  </label>
                                            <div class="position-relative d-flex align-items-center">
                                                ...
                                                <input class="form-control form-control-solid ps-12" name="from_date" placeholder="{{trans('blog.from')}}" id="kt_datepicker_1" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-7">
                                            <div class="position-relative d-flex align-items-center">
                                                ...
                                                <input class="form-control form-control-solid ps-12" name="to_date" placeholder="{{trans('blog.to')}}" id="kt_datepicker_2" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-center pt-15">
                                        <button type="button" class="btn btn-light me-3" data-bs-dismiss="modal">{{trans('blog.close')}} </button>
                                        <button type="submit" class="btn btn-primary" id="submit">
                                            <span class="indicator-label">{{trans('blog.save')}} </span>
