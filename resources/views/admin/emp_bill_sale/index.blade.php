    ...
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            columns: [
                ...
                {data: 'quntitty', name: 'quntitty'},
                {data: 'note', name: 'note'},
                {data: 'description', name: 'description'},
                {data: 'sale_type_id', name: 'sale_type_id'},
                {data: 'valued_time', name: 'valued_time'},
                {data: 'sale_id', name: 'sale_id'},
                {data: 'created_at', name: 'created_at'},
                {data: 'tvalue', name: 'tvalue'},
                {data: 'tquntitty', name: 'tquntitty'},
            ]
        });
        ...
        $('#empsaled_id,#sale_type_id,#kt_datepicker_1,#kt_datepicker_2').change(function() {
            table.draw();
        });
