    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card no-border">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            {{-- <a href="{{route('admin.bill_sales.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
                ...
                <div class="card-body py-4">
                    ...
                    <div class="row mb-6">
                        <div class="col-sm-5">
                            <label class="col-sm-6 fw-semibold fs-6 mb-2">{{trans('lang.name')}}-{{trans('employee.employees')}}</label>
                            <div class="col-sm-8 fv-row">
                                <select  data-placeholder="Select an option" required class=" input-text form-control  form-select  mb-3 mb-lg-0 text-center" id="empsaled_id"  name="empsaled_id" data-kt-repeater="select2" data-control="select2" >
                        ...
                        <div class="col-sm-5">
                            <label class="col-sm-6 fw-semibold fs-6 mb-2">{{trans('lang.sales')}}-{{trans('lang.type_type')}}</label>
                            <div class="col-sm-8 fv-row">
                        ...
                        <div class="col-sm-2">
                            <label class="col-sm-8 fw-semibold fs-6 mb-2"></label>
                                <div class="col-sm-8 d-flex align-items-center">
                                    <a href="{{route('admin.emp_bill_sales.index')}}" class="btn btn-primary btn-lg " id="searchbtn" >
                                        refresh
                                    </a> 
                                </div> 
                        </div>
                    ...
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-start">{{trans('lang.name')}} {{trans('employee.employees')}}</th>
                                ...
                                <th class="min-w-125px text-start">{{trans('lang.name')}}-{{trans('lang.customer')}}</th>
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                url: "{{ route('admin.emp_bill_sales.index') }}",
                data: function (d) {
                    d.is_active = $('#is_active').val(),
                    d.empsaled_id = $('#empsaled_id').val(),
                    d.sale_type_id = $('#sale_type_id').val(),
                    d.search = $('#search').val()
                }
            },
            columns: [
                ...
                {data: 'sale_type_id', name: 'sale_type_id'},
        ...
        $('#empsaled_id,#sale_type_id').change(function() {
            table.draw();
        });
            ...
            if (checkIDs.length > 0) {
                ...
                Swal.fire({
                    ...
                    if (isConfirm.value) {
                        $.ajax(
                        {
                            url: "{{route('admin.bill_sales.delete')}}",
                            type: 'post',
                            dataType: "JSON",
                            data: {
                                "id": checkIDs,
