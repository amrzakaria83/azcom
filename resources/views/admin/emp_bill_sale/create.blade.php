                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="col-sm-6 fv-row">
                                    <select  data-placeholder="Select an option" class="input-text form-control form-select mb-3 mb-lg-0 text-center" id="cut_sale_id" name="cut_sale_id" data-control="select2" >
                                        ...
                                        <option  value="add">{{trans('employee.add_new')}}</option>
                                            ...
                                            <div data-repeater-item>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <input type="number" class="form-control mb-2 mb-md-0 text-center" required placeholder="Number" name="quantityproduc"/>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label class="form-label required">{{trans('lang.sell_price')}}</label>
                                                        <input type="number" class="form-control mb-2 mb-md-0 text-center" required placeholder="Number" name="sellpriceproduct"/>
                                                    </div>
