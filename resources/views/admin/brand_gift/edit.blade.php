    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin::Form-->
                <form action="{{route('admin.brand_gifts.update')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                    @csrf
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="row mb-6">
                            <label class="col-lg-2 col-form-label fw-semibold fs-6"> {{trans('lang.type_type')}}</label>
                            <div class="col-lg-8 d-flex align-items-center">
                                <select   data-placeholder="Select an option" class=" input-text form-control  form-select  mb-3 mb-lg-0" value="{{$data->class_gift}}"  name="class_gift">
                                        <option value="0" @if($data->class_gift == '0') selected @endif>{{trans('lang.general_gifts')}}</option>
                                        <option value="1" @if($data->class_gift == '1') selected @endif>{{trans('lang.specital_gifts')}}</option>                                    
                                        <option value="2" @if($data->class_gift == '2') selected @endif>{{trans('lang.valuable_gifts')}}</option>                                    
                                    </select>
                            </div>
                        </div>
