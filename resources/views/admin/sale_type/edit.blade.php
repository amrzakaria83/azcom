    ...
    <div id="kt_app_content_container" class="app-container container-fluid">       
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form action="{{route('admin.sale_types.update')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                    @csrf
                    ...
                    <div class="card-body border-top p-9">
                        <h1>
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="name_en" placeholder="name " value="{{$data->name_en}}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 text-center text-dark" />
                            </div>
                        </div>
                        <div class="row mb-6">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" id="description" name="description" placeholder="description" value="{!! $data->description !!}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 text-center text-dark" />
                            </div>
                        </div>
