                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-12 fv-row">
                                <select  data-placeholder="Select an option" class=" input-text form-control  form-select  mb-3 mb-lg-0 text-center" id="employeeid" name="employeeid" data-control="select2" >
                                    <option  disabled selected>Select an option</option>
                                        @foreach (\app\Models\Employee::get() as $asd)
                        ...
                        <div class="col-sm-3">
                            <label class="col-sm-12 fw-semibold fs-6 mb-2">{{trans('employee.method_for_payment')}}</label>
                            <div class="col-sm-12 fv-row">
                            <select   data-placeholder="Select an option" class=" input-text form-control  form-select  mb-3 mb-lg-0" id="method_for_payment"  name="method_for_payment">
                    ...
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-start">{{trans('employee.employee')}}</th>
                                <th class="min-w-125px text-start">{{trans('employee.phone')}}</th>
                                <th class="min-w-125px text-start">{{trans('employee.method_for_payment')}}</th>
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                ...
                data: function (d) {
                    ...
                    d.method_for_payment = $('#method_for_payment').val(),
            ...
            columns: [
                ...
                {data: 'method_for_payment', name: 'method_for_payment'},
        ...
        $('#employeeid,#method_for_payment').change(function() {
            table.draw();
        });
