        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form action="{{route('admin.areas.store')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                    ...
                    <div class="row mb-6">
                            <label class="col-lg-2 col-form-label required fw-semibold fs-6">{{trans('lang.country')}}</label>
                        ...
                        <div class="row mb-6" id="egypt">
                            <label for="governateSelect" class="col-lg-2 col-form-label fw-semibold fs-6" >
                            ...
                            <label for="citySelect" class="col-lg-2 col-form-label fw-semibold fs-6" >
                        ...
                        <div class="row mb-6" id="uae">
                            <label for="emeratSelect" class="col-lg-2 col-form-label fw-semibold fs-6" >
