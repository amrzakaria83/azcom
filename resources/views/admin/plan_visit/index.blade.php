...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <h1>{{trans('lang.plan')}} {{trans('lang.visit')}}-{{trans('lang.all')}}</h1>
                ...
                <div class="card-header border-0 pt-6">
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-db-table-filter="search" id="search" name="search" class="form-control form-control-solid bg-light-dark text-dark w-250px ps-14" disabled placeholder="Search user" />
                        </div>
                    </div>
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            @can('visit plan new')
                            <a href="{{route('admin.plan_visits.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
                ...
                <div class="card-body py-4">
                    <div class="row mb-6">
                        ...
                        <div class="col-sm-3 fv-row">
                            <select  data-placeholder="Select an option" class=" input-text form-control  form-select  mb-3 mb-lg-0 text-center" id="emphplan_id" name="emphplan_id" data-control="select2" >
                        ...
                        <label class="col-sm-2 col-form-label fw-semibold fs-6">{{trans('lang.name')}}-{{trans('lang.contact')}}</label>
                        <div class="col-sm-3 fv-row">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-sm-6">
                            <label class="col-sm-2 fw-semibold fs-6 mb-2"> {{trans('lang.status')}} {{trans('lang.visit')}}</label>
...
<script>
    $("#kt_datepicker_1").flatpickr({defaultDate: new Date(new Date().setMonth(new Date().getMonth() - 0))});
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                url: "{{ route('admin.plan_visits.index') }}",
                data: function (d) {
                    d.is_active = $('#is_active').val(),
                    d.emphplan_id = $('#emphplan_id').val(),
        ...
        $('#emphplan_id,#contact_id,#kt_datepicker_1,#kt_datepicker_2,#status_visit').change(function() {
            table.draw();
        });
