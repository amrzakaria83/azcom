    ...
    <div id="kt_app_content_container" class="app-container container-fluid">       
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form action="{{route('admin.plan_visits.store')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                    @csrf
                    <!--begin::Card body-->
                    <div class="card-body  p-9">
                        <h1>
                            <span>{{trans('lang.plan')}}-{{trans('lang.visit')}}-{{trans('employee.add_new')}}</span>
                            </h1>
                            <br>
                        ...
                        <div class="row mb-6">
                                <!-- <label class="col-lg-2 col-form-label required fw-semibold fs-6">{{trans('lang.name')}}-{{trans('lang.employee')}}</label>
                                    <div class="col-lg-3 fv-row">
                                        <select  data-placeholder="Select an option" class=" input-text form-control  form-select  mb-3 mb-lg-0 text-center" required id="emphplan_id" name="emphplan_id" data-control="select2" >
                            ...
                            <div class="row mb-6">
                                <label class="col-lg-2 col-form-label required fw-semibold fs-3 text-info">{{trans('lang.name')}}-{{trans('lang.center')}}</label>
                                    <div class="col-lg-3 fv-row">
                                        <select  data-placeholder="Select an option" class=" input-text form-control  form-select  mb-3 mb-lg-0 text-center" required  id="center_id" name="center_id" data-control="select2" >
                                            <option  disabled selected>Select an option</option>
                                            @if(isset($datacenter))
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-3 fv-row">
                                <input type="datetime-local" class="form-control mb-3 mb-lg-0" id="from_time" name="from_time" value="<?php echo date('Y-m-d\TH:i'); ?>" min="<?php echo date('Y-m-d\TH:i'); ?>">
                                </div>
                            <!-- </div>
