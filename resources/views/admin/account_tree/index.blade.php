    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card no-border">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            <a href="{{route('admin.account_trees.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
                ...
                <div class="card-body py-4">
                    <!--begin::Table-->
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6 text-center" id="kt_datatable_table">
                        <!--begin::Table head-->
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-center text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-center">اسم البند</th>
                                <th class="min-w-125px text-center">القيمة</th>
                                <th class="min-w-125px text-center">البند الاعلى</th>
                                <th class="min-w-125px text-center">طبيعة</th>
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                url: "{{ route('admin.account_trees.index') }}", 
                data: function (d) {
                    d.type = $('#type').val(),
                    d.search = $('#search').val()
                }
