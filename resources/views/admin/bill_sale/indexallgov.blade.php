    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card no-border">
                ...
                <div class="card-body py-4">
                    ...
                    <div class="row mb-6">
                        @if(isset($govid))<input type="hidden" id="govid" value="{{$govid}}" />@endif
                    ...
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-center">{{trans('lang.counttotal')}} {{trans('lang.products')}}</th>
...
<script>
    ...
    var govId = $('#govid').val();
        ...
        $('#kt_datepicker_1, #kt_datepicker_2, #cut_sale_id').on('change', function() {
            table.draw();
        });
        ...
        $("#btn_delete").click(function(event){
            ...
            if (checkIDs.length === 0) {
                toastr.error("", "حدد العناصر أولاً");
                return;
            }
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if(response.message === "success") {
                                ...
                                toastr.error("عفواً لم يتم الحذف");
                            }
                        },
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                url: "{{ route('admin.bill_sales.indexallgov') }}",
                data: function (d) {
                    // d.is_active = $('#is_active').val(),
                    // d.from_time = $('#kt_datepicker_1').val(),
                    // d.to_date = $('#kt_datepicker_2').val(),
        ...
        $('#kt_datepicker_1,#kt_datepicker_2,#cut_sale_id').change(function() {
            table.draw();
        });
        $('#submit').click(function(){
            $("#kt_modal_filter").modal('hide');
