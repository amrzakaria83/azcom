                        ...
                        <h1>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-sm-3 d-flex align-items-center text-center">
                                    <select class="form-select text-center" disabled autofocus required aria-label="Select example" id="vacationrequesttype" name="vacationrequesttype" >
                                        <option value="0" @if($data->vacationrequesttype == '0') selected disabled @endif >{{trans('lang.general_leave')}}</option>
                                        <option value="1" @if($data->vacationrequesttype == '1') selected disabled @endif >{{trans('lang.sick_leave')}}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-6">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-sm-3 d-flex align-items-center text-center">
                                    <select class="form-select text-center" autofocus required aria-label="Select example" id="typevacation" name="typevacation" >
                                            <option value="0" @if($data->typevacation == '0') selected disabled @endif >{{trans('lang.no_salary')}}</option>
                                            <option value="1" @if($data->typevacation == '1') selected disabled @endif >{{trans('lang.half_salary')}}</option>
                                            <option value="2" @if($data->typevacation == '2') selected disabled @endif >{{trans('lang.full_salary')}}</option>
                                        </select>
                                </div>
                            <!-- </div>
                            <div class="row mb-6"> -->
                            ...
                            <div class="row mb-6">
                                <label class="col-lg-2 col-form-label fw-semibold fs-6">Director's note</label>
                                <div class="col-lg-8 fv-row">
