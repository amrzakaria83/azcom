    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin::Form-->
                <form action="{{route('admin.products.update')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                    @csrf
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="row mb-6">
                            <label class="col-lg-2 col-form-label required fw-semibold fs-6">{{trans('lang.sell_price')}}</label>
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="sell_price" placeholder="{{trans('lang.sell_price')}}" value="{{$data->sell_price}}" required class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
                            </div>
                        </div>
                        {{-- <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                ...
                                <div class="input-group  mb-5">
                                    ...
                                    <input type="text" class="form-control" name="percent" value="{{$data->percent}}" required aria-label=""/>
