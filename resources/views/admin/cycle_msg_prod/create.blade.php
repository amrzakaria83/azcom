    ...
    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_header_nav'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            <li class="breadcrumb-item text-muted px-2">
                <a  href="{{route('admin.products.index')}}" class="text-muted text-hover-primary">{{trans('lang.products')}}</a>
            </li>
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">       
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form action="{{route('admin.cycle_msg_prods.store')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                    @csrf
                    <!--begin::Card body-->
                    <div class="card-body  p-9">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <select  data-placeholder="Select an option" class=" input-text form-control  form-select  mb-3 mb-lg-0"  name="prod_id"  data-allow-clear="true"   data-control="select2" >
                                    @if(isset($prod))
                        ...
                        <div class="row mb-6">
                            <label class="col-lg-2 col-form-label required fw-semibold fs-3 text-info">{{trans('lang.title')}}</label>
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="title" placeholder="{{trans('lang.title')}}" value="" required class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
                            </div>
                        </div>

                        <div class="row mb-6">
                            <label class="col-lg-2 col-form-label required fw-semibold fs-3 text-info">{{trans('lang.end_to')}}</label>
                            <div class="col-lg-10 fv-row">
                                <input id="kt_datepicker_4" type="date" name="valued_to"  placeholder=""  class="form-control form-control-solid text-center" />
                            </div>
                        </div>
...
$("#kt_datepicker_4").flatpickr({
                        defaultDate: new Date(new Date()).fp_incr(365),  // Set day to 1 and then increase by 1 years
                        enableTime: false,
                        allowInput: true,
                        dateFormat: "Y-m-d",
                        });
