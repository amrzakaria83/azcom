    ...
    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_header_nav'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            <li class="breadcrumb-item text-muted px-2">
                <a  href="{{route('admin.cycle_msg_prods.index')}}" class="text-muted text-hover-primary">{{trans('lang.administrators')}}</a>
            </li>
    ...
    <div class="card">
            ...
            <div class="card-body p-9">
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-lg-9">
                        <div class="fw-bold fs-5">{{$data->getprod->name_en}}</div>
                    </div>
                </div>
                ...
                <div class="row mb-8">
                    <div class="col-xl-2">
                        <div class="fs-6 fw-semibold">{{trans('lang.valued_date')}} </div>
                    </div>
                    <div class="col-xl-9 fv-row">
                        <div class="fw-bold fs-5">{{ date('y-m-d', strtotime($data->valued_to))}}</div>
                    </div>
                </div>
