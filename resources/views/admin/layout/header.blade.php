    ...
    <div class="d-flex flex-stack flex-grow-1">
        <div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
            ...
            <a href="{{url('/admin')}}" class="app-sidebar-logo">
                <img alt="Logo" src="{{$settings->getFirstMediaUrl('logo')}}" class="h-100px theme-light-show" />
                <img alt="Logo" src="{{$settings->getFirstMediaUrl('logoDark')}}" class="h-100px theme-dark-show" />
            </a>
            <!--end::Logo-->
        </div>
        ...
        <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
            ...
            <div class="app-navbar-item ms-2 ms-lg-6">
                <!--begin::Menu- wrapper-->
                <?php 
                    $messages_noti = \App\Models\Message::where('status', 'unread')->get();
                    $students_noti = [];
                ?>
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                    ...
                    <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{asset('dash/assets/media/misc/menu-header-bg.jpg')}}')">
                        ...
                        <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white opacity-75 opacity-state-100 pb-4" data-bs-toggle="tab" href="#kt_topbar_notifications_3">الاشتراكات</a>
                            </li>
                        </ul>
                        <!--end::Tabs-->
                    </div>
                    ...
                    <div class="tab-content">
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            @if ($message_item->sender_type == 'student')
                                                <a href="{{url('/admin/messages/getmsgdetails')}}/{{$message_item->sender_id}}/{{$message_item->receiver_id}}" class="text-gray-800 text-hover-primary fw-semibold">رساله الى </a>
                                            @else
                                                <a href="{{url('/admin/messages/getmsgdetails')}}/{{$message_item->receiver_id}}/{{$message_item->sender_id}}" class="text-gray-800 text-hover-primary fw-semibold">رساله الى </a>
                                            @endif
                                        </div>
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                        <span class="badge badge-light fs-8">
                                            {{$message_item->receiver->name ?? ''}}
                        ...
                        <div class="tab-pane fade" id="kt_topbar_notifications_3" role="tabpanel">
                            @foreach ($students_noti as $student_item)
                            <div class="scroll-y mh-325px my-5 px-8">
                                <!--begin::Item-->
                                <div class="d-flex flex-stack py-4">
                                    <!--begin::Section-->
                                    <div class="d-flex align-items-center me-2">
                                        <!--begin::Title-->
                                        <a href="" class="text-gray-800 text-hover-primary fw-semibold">{{$student_item->name}}</a>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Section-->
                                </div>
