...
@section('content')
    ...
    <h1>{{trans('lang.center')}}-{{trans('lang.all')}}</h1>
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            @can('center new')
                            <a href="{{route('admin.centers.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
                    ...
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-start">{{trans('lang.address')}}</th>
                            ...
                            <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{route('admin.centers.storeworkhour')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                                                    @csrf
                                                    <input type="hidden"  id="centerid" value="" name="id_model"/>
                                                    <input type="hidden"  id="model" value="center" name="model_name"/>
            ...
            if (checkIDs.length > 0) {
                ...
                Swal.fire({
                    ...
                    if (isConfirm.value) {
                        $.ajax(
                        {
                            url: "{{route('admin.centers.delete')}}",
                            type: 'post',
                            dataType: "JSON",
                            data: {
                                "id": checkIDs,
...
$('#kt_modal_1b').on('show.bs.modal', function (event) {
    ...
    var centerId = button.data('centerId');
    var centername = button.data('centername');
    var titleElement = $('#centername');
    var idcenter = $('#centerid');
    titleElement.text(centername);
    idcenter.val(centerId);
