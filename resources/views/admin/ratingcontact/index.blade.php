            ...
            <div class="card no-border">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            <!-- <a href="{{route('admin.ratingcontacts.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
                ...
                <div class="card-body py-4">
                    <div class="row mb-6">
                        ...
                        <div class="col-sm-4">
                            <label class="col-sm-8 fw-semibold fs-6 mb-2">{{trans('lang.name')}}-{{trans('lang.ratings')}}</label>
                            <div class="col-sm-12 fv-row">
                                <select  data-placeholder="Select an option" class=" input-text form-control  form-select  mb-3 mb-lg-0 text-center" id="rate_id" name="rate_id" data-control="select2" >
                                    <option  disabled selected>Select an option</option>
                                        @foreach (\App\Models\Rating::where('status' , 0)->get() as $contac)
                                            <option value="{{$contac->id}}">{{$contac->name_en}}</option>
                                            @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <label class="col-sm-8 fw-semibold fs-6 mb-2">{{trans('lang.total')}}-{{trans('lang.ratings')}}</label>
                            <div class="col-sm-6 fv-row">
                                <a href="{{route('admin.contacts.indextotal')}}" class="">
                                    <button type="button" class="btn btn-success btn-lg " >
                                        {{trans('lang.total')}}-{{trans('lang.ratings')}}
                                    </button> 
                                </a>
                            </div>
                        </div>
                    ...
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-start">{{trans('lang.ratings')}}</th>
                                <th class="min-w-125px text-start">{{trans('lang.value')}}</th>
                                <th class="min-w-125px text-start">{{trans('lang.valued_date')}}</th>
                                <th class="min-w-125px text-start">{{trans('lang.largestdegree')}}</th>
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                url: "{{ route('admin.ratingcontacts.index') }}",
                data: function (d) {
                    d.is_active = $('#is_active').val(),
                    d.rate_id = $('#rate_id').val(),
            ...
            columns: [
                ...
                {data: 'largestdegree', name: 'largestdegree'},
        ...
        $('#contact_id,#rate_id').change(function() {
            table.draw();
        });
