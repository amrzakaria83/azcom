    ...
    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_header_nav'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            <li class="breadcrumb-item text-muted px-2">
                <a  href="{{route('admin.list_contacs.index')}}" class="text-muted text-hover-primary">{{trans('lang.nutrilist')}}</a>
            </li>
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">       
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form action="{{route('admin.list_contacs.store')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                    @csrf
                    <!--begin::Card body-->
                    <div class="card-body  p-9">
                    <h1>
                        <span>{{trans('lang.nutrilist')}}-{{trans('employee.add_new')}}</span>
                    </h1><br>
                    <div class="row mb-6">
                            <label class="col-lg-2 col-form-label required fw-semibold fs-5 text-info">{{trans('employee.name')}} {{trans('employee.employee')}}</label>
                            <div class="col-lg-8 fv-row">
                            <select  data-placeholder="Select an option" required class=" input-text form-control  form-select  mb-3 mb-lg-0"  id="emplist_id"  name="emplist_id" data-control="select2">
