...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <h1>
            <span>{{trans('lang.expense')}}-{{trans('lang.request')}}-{{trans('lang.all')}}</span>
            </h1>
            <br>
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            @can('expense new')
                            <a href="{{route('admin.expense_requests.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
...
<script>
    $(function () {
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                url: "{{ route('admin.expense_requests.index') }}",
                data: function (d) {
            ...
            if (checkIDs.length > 0) {
                ...
                Swal.fire({
                    ...
                    if (isConfirm.value) {
                        $.ajax(
                        {
                            url: "{{route('admin.expense_requests.delete')}}",
                            type: 'post',
                            dataType: "JSON",
                            data: {
                                "id": checkIDs,
