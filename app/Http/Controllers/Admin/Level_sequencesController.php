...
class Level_sequencesController extends Controller
{
    ...
    {
        $data = Level_sequence::get();

        if ($request->ajax()) {
            $data = Level_sequence::query();
            ...
            return Datatables::of($data)
                ...
                ->addColumn('actions', function($row){
                    $actions = '<div class="ms-2">
                                <a href="'.route('admin.level_sequences.edit', $row->id).'" class="btn btn-sm btn-icon btn-info btn-active-dark me-2" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
        ...
        return view('admin.level_sequence.index');
    }

    public function show($id)
    {
        $data = Area::find($id);
        return view('admin.level_sequence.show', compact('data'));
    }

    public function create()
    {
        return view('admin.level_sequence.create' );
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/level_sequences')->with('message', 'Added successfully')->with('status', 'success');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.level_sequence.edit', compact('data'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('admin/level_sequences')->with('message', 'Modified successfully')->with('status', 'success');
    }
    ...
    public function indextreehie()
    {
        ...
        $data = Level_sequence::where('status', 0)->orderBy('id', 'desc')->get();

        // Build a collection for efficient lookup
        $accountCollection = $data->keyBy('id');

        return view('admin.level_sequence.indextreehie', compact('data'));
    }
