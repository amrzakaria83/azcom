...
class Cust_collectionsController extends Controller
{

    public function index(Request $request)
    {
        $data = Cust_collection::get(); 

        if ($request->ajax()) {
            $data = Cust_collection::query();
    ...
    public function update(Request $request)
    {
        ...
        $cust_collection = Cust_collection::find($request->id);
        $data = Cust_collection::where('id', $request->id)->update([
            'emp_id' => Auth::guard('admin')->user()->id,
            'cust_id' => $request->cust_id,
            'value' => $request->value,
            'note' => $request->note,
    ...
    {   
        ...
        try{
            Cust_collection::whereIn('id',$request->id)->delete();
        } catch (\Exception $e) {
