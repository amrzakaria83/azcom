...
Route::get('/get-customers',[ApiController::class ,'getCustomerSale']);
Route::get('/get-type-sale',[ApiController::class ,'getTypeSale']);
Route::post('/request-invoice',[ApiController::class ,'requestInvoice']);
Route::post('/request-customer-collection',[ApiController::class ,'requestCutomerCollection']);
